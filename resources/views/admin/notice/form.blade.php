<div class="form-body">
    ...
    <div class="form-group">
        {!! Form::label('download_link', 'Download link', ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-md-10">
            {!! Form::text('download_link',isset($notice->download_link) ? $notice->download_link : null,['class'=> 'form-control']) !!}
        </div>
    </div>
