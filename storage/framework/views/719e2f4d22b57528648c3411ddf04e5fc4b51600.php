				...
				<div id="department-container">
					...
					<div class="department-section">
						<div class="department-overview">
							...
							<?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="date">
										<p><span><?php echo e($event->created_at->format('j')); ?></span><span class="month"><?php echo e($event->created_at->format('M y')); ?></span></p>
									</div>
									<a href="<?php echo e(url('news-events', [$event->id, make_slug($event->title)] )); ?>"><?php echo e($event->title); ?></a>
								</li>
