<div class="form-body">
    ...
    <div class="form-group">
        <?php echo Form::label('position','Designation',['class'=>'col-sm-2 control-label']); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <?php echo Form::textarea('description',isset($member->description) ? $member->description : null,['class'=> 'form-control details']); ?>
    ...
    <div class="form-group">
        <?php echo Form::label('idno','Teacher ID',['class'=>'col-sm-2 control-label']); ?>

        <div class="col-md-2">
            <?php echo Form::text('idno',isset($member->idno) ? $member->idno : null, ['class'=> 'form-control']); ?>
