                            ...
                            <table class="table mb0"> 
                                ...
                                @foreach($departments as $department)
                                    <tr> 
                                        ...
                                        <td><img src="/{{ $department->image }}" class="img-responsive" alt=""></td>
                                        <td class="align-middle">
                                            <a class="btn btn-sm btn-primary" href="{{ url('/department/'.$department->id.'/edit') }}">Edit</a>
                                        </td>
                                        <td class="align-middle">
                                            {!! Form::open([ 'method' => 'Delete', 'url' => ['/department', $department->id]]) !!}
