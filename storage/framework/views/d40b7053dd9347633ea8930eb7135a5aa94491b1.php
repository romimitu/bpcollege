<div class="form-body">
    <div class="form-group">
        ...
        <div class="col-md-10">
            <?php echo Form::text('title',isset($media->title) ? $media->title : null, ['class'=> 'form-control']); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <?php echo Form::textarea('description',isset($media->description) ? $media->description : null,['class'=> 'form-control details']); ?>
        ...
        <div class="col-md-10">
            <div class="fileinput fileinput-new" data-provides="fileinput">
                ...
                <?php if(isset($media->image)): ?>
                    <img src="/<?php echo e($media->image); ?>" alt="" />
                <?php else: ?>
