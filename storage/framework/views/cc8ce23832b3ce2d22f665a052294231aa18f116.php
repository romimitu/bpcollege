<div class="form-body">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <?php echo Form::textarea('details',isset($page->details) ? $page->details : null,['class'=> 'form-control details']); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <?php echo Form::textarea('sub_details',isset($page->sub_details) ? $page->sub_details : null,['class'=> 'form-control details',]); ?>
